import bg from "../assets/theme/rose/bg.png"; 
import atas from "../assets/theme/rose/atas.png"; 
import bawah from "../assets/theme/rose/bawah.png"; 
import atasDua from "../assets/theme/rose/atas-dua.png"; 
import bawahDua from "../assets/theme/rose/bawah-dua.png";
import bingkai from "../assets/theme/rose/bingkai.png";
import lingkaran from '../assets/theme/rose/lingkaran.png';
...
const Rose = () => {
  ...
  return (
    <Layout tamu={tamu} background={background} bingkai={bingkai} dataCouple={dataCouple} fotoDefault={fotoDefault} warnaPrimary={'#9d323e'} posisiLingkaran={'w-[210px] -mt-[48px] ms-[35px]'}/>
  )
}
